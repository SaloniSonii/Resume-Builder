import { FilePenLineIcon, PencilIcon, PillIcon, TrashIcon, UploadCloud, UploadCloudIcon, XIcon } from 'lucide-react'
        ...
        {showUploadResume &&(
          <form onSubmit={uploadResume} onClick={()=> setShowUploadResume(false)} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
            <div onClick = {e=> e.stopPropagation()} className='relative bg-slate-50 brder shadow-md rounded-lg w-full max-w-sm p-6'>
              ...
              <button className='w-full py-2 bg-green-600 text-white rounded hover:bg-gray-700 transition-colors'>Upload Resume</button>
